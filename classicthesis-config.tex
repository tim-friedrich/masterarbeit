...
\newcommand{\myTitle}{Webbasierte Verteilung großer Datenmengen in lokalen Netzwerken
\xspace}

\newcommand{\myGermanTitle}{Web-based distribution of large data in local networks}\newcommand{\myDegree}{Bachelor of Science\xspace}
...
\newcommand{\clients}{Clients\xspace}
...
\addto\captionsamerican{%
  ...
  \renewcommand{\listingautorefname}{Auflistung}%
}
