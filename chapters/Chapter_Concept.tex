...
\begin{itemize}
	\item system test
	\item script wird nicht geladen falls browser nicht unterstützt wird
	\item falls verbindung nicht aufgebaut werden kann wird client aussortiert
	\item über normales cdn
	\item 
\end{itemize}
